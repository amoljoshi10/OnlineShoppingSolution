    ...
    */
    workspace "Online Shopping Platform" "This is an example workspace to illustrate the key features of Structurizr, via the DSL" {
        ...
        model {
            ...
            singlePageApplication -> productService "API Call"
            singlePageApplication -> cartService "API Call"
            singlePageApplication -> orderService "API Call"
        

            mobileApp -> productService "API Call"
            mobileApp -> cartService "API Call"
            mobileApp -> orderService "API Call"
