    ...
    workspace "Online Shopping Platform" "This is an example workspace to illustrate the key features of Structurizr, via the DSL" {
        ...
        model {
            ...
            deploymentEnvironment "Development" {
                deploymentNode "Developer Laptop" "" "Microsoft Windows 10 or Apple macOS" {
                    ...
                    deploymentNode "Docker Container - Database Server" "" "Docker" {
                        ...
                        developertrainDBInstance = containerInstance productsDB
                developercartDBInstance = containerInstance cartDB
                        }
                    }
                }
                deploymentNode "Online Shopping Platform" "" "Online Shopping Platform on cloud" "" {
            ...
            deploymentEnvironment "Live" {
                ...
                livePrimaryDatabaseInstanceproductsDB = containerInstance productsDB
                livePrimaryDatabaseInstancecartDB = containerInstance cartDB
                        }
                    }
                ...
                liveSecondaryDatabaseInstanceproductsDB = containerInstance productsDB "Failover"
                liveSecondaryDatabaseInstancecartDB = containerInstance cartDB "Failover"
                        }
                    }
        ...
        views {
            ...
            deployment shoppingSystemContext "Development" "DevelopmentDeployment" {
                include *
                animation {
                    developerSinglePageApplicationInstance
                    developerApiApplicationInstance
                    developertrainDBInstance
                developercartDBInstance
                }
                autoLayout
            }

            deployment shoppingSystemContext "Live" "LiveDeployment" {
                include *
                animation {
                    liveSinglePageApplicationInstance
                    liveMobileAppInstance
                    liveApiApplicationInstance
            livePrimaryDatabaseInstanceproductsDB
            liveSecondaryDatabaseInstanceproductsDB
            livePrimaryDatabaseInstancecartDB
            liveSecondaryDatabaseInstancecartDB
                }
                autoLayout
            }
